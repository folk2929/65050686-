...
ระบบพึ่งพาข้อมูลจาก Wikipedia เป็นหลัก ซึ่งอาจมีข้อจำกัดด้านความครบถ้วน ความทันสมัย หรืออคติของแหล่งข้อมูล

การกำหนด keyword เช่น controversy หรือ achievements อาจมีผลต่อทิศทางของข้อมูลที่ถูกค้นพบ และอาจไม่ครอบคลุมทุกแง่มุมที่สำคัญ

ระบบจำกัดจำนวนข้อเท็จจริงไว้ที่ 3 ข้อต่อด้าน เพื่อควบคุมโครงสร้างและความสมดุล ซึ่งอาจไม่สะท้อนภาพรวมทั้งหมดของบุคคลหรือเหตุการณ์นั้น
